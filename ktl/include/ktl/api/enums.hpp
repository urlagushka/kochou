...
enum class image_tiling : std::uint32_t
{
    optimal = 0,
    linear = 1
};
...
enum class pipeline_bind_point : std::uint32_t
{
    graphics = 0,
    compute = 1
};

enum class pipeline_cache_header_version : std::uint32_t
{
    one = 1
};

enum class pipeline_cache_create_flag_bits : std::uint32_t
{
};
...
enum class sharing_mode : std::uint32_t
{
    exclusive = 0,
    concurrent = 1
};
...
enum class internal_allocation_type : std::uint32_t
{
    executable = 0
};

enum class system_allocation_scope : std::uint32_t
{
    command = 0,
    object = 1,
    cache = 2,
...
enum class subpass_contents : std::uint32_t
{
    iinline = 0,
...
enum class descriptor_update_template_type : std::uint32_t
{
    descriptor_set = 0
};
...
enum class ray_tracing_invocation_reorder_mode_ext : std::uint32_t
{
    none_ext = 0,
    reorder_ext = 1
};

enum class ray_tracing_lss_indexing_mode_nv : std::uint32_t
{
    list_nv = 0,
    successive_nv = 1
};

enum class ray_tracing_lss_primitive_end_caps_mode_nv : std::uint32_t
{
    one_nv = 0,
    chained_nv = 1
};

enum class direct_driver_loading_mode_lunarg : std::uint32_t
{
    exclusive_lunarg = 0,
    inclusive_lunarg = 1
};

enum class anti_lag_mode_amd : std::uint32_t
{
...
enum class anti_lag_stage_amd : std::uint32_t
{
    input_amd = 0,
    present_amd = 1
};

enum class queue_flag_bits : std::uint32_t
{
    graphics_bit = (1U << 0),
    compute_bit = (1U << 1),
    transfer_bit = (1U << 2),
...
enum class cull_mode_flag_bits : std::uint32_t
{
    none = 0,
    ront_bit = (1U << 0),
    back_bit = (1U << 1),
...
enum class render_pass_create_flag_bits : std::uint32_t
{
};

enum class device_queue_create_flag_bits : std::uint32_t
{
};

enum class memory_property_flag_bits : std::uint32_t
{
...
enum class memory_heap_flag_bits : std::uint32_t
{
    device_local_bit = (1U << 0)
};

enum class access_flag_bits : std::uint32_t
{
...
enum class buffer_usage_flag_bits2 : std::uint64_t
{
...
enum class buffer_create_flag_bits : std::uint32_t
{
...
enum class shader_stage_flag_bits : std::uint32_t
{
    vertex_bit = (1U << 0),
...
enum class image_usage_flag_bits : std::uint32_t
{
    transfer_src_bit = (1U << 0),
    transfer_dst_bit = (1U << 1),
    sampled_bit = (1U << 2),
...
enum class image_create_flag_bits : std::uint32_t
{
    sparse_binding_bit = (1U << 0),
    sparse_residency_bit = (1U << 1),
    sparse_aliased_bit = (1U << 2),
...
enum class image_view_create_flag_bits : std::uint32_t
{
};

enum class sampler_create_flag_bits : std::uint32_t
{
};

enum class pipeline_create_flag_bits : std::uint32_t
{
...
enum class pipeline_create_flag_bits2 : std::uint64_t
{
...
enum class pipeline_shader_stage_create_flag_bits : std::uint32_t
{
};

enum class color_component_flag_bits : std::uint32_t
{
    r_bit = (1U << 0),
    g_bit = (1U << 1),
    b_bit = (1U << 2),
...
enum class fence_create_flag_bits : std::uint32_t
{
    signaled_bit = (1U << 0)
};

enum class semaphore_create_flag_bits : std::uint32_t
{
};

enum class format_feature_flag_bits : std::uint32_t
{
...
enum class query_control_flag_bits : std::uint32_t
{
    precise_bit = (1U << 0)
};

enum class query_result_flag_bits : std::uint32_t
{
    i64_bit = (1U << 0),
    wait_bit = (1U << 1),
...
enum class command_buffer_usage_flag_bits : std::uint32_t
{
...
enum class query_pipeline_statistic_flag_bits : std::uint32_t
{
...
enum class memory_map_flag_bits : std::uint32_t
{
};

enum class image_aspect_flag_bits : std::uint32_t
{
    color_bit = (1U << 0),
    depth_bit = (1U << 1),
    stencil_bit = (1U << 2),
...
enum class sparse_image_format_flag_bits : std::uint32_t
{
...
enum class sparse_memory_bind_flag_bits : std::uint32_t
{
    metadata_bit = (1U << 0)
};

enum class pipeline_stage_flag_bits : std::uint32_t
{
...
enum class command_pool_create_flag_bits : std::uint32_t
{
    transient_bit = (1U << 0),
    reset_command_buffer_bit = (1U << 1)
};

enum class command_pool_reset_flag_bits : std::uint32_t
{
    release_resources_bit = (1U << 0)
};

enum class command_buffer_reset_flag_bits : std::uint32_t
{
    release_resources_bit = (1U << 0)
};

enum class sample_count_flag_bits : std::uint32_t
{
    i1_bit = (1U << 0),
    i2_bit = (1U << 1),
    i4_bit = (1U << 2),
...
enum class attachment_description_flag_bits : std::uint32_t
{
    may_alias_bit = (1U << 0)
};

enum class stencil_face_flag_bits : std::uint32_t
{
    ront_bit = (1U << 0),
    back_bit = (1U << 1),
    ront_and_back [[deprecated]] = 0x00000003
};

enum class descriptor_pool_create_flag_bits : std::uint32_t
{
    ree_descriptor_set_bit = (1U << 0)
};

enum class dependency_flag_bits : std::uint32_t
{
    by_region_bit = (1U << 0)
};

enum class semaphore_type : std::uint32_t
{
    binary = 0,
    timeline = 1
};

enum class semaphore_wait_flag_bits : std::uint32_t
{
    any_bit = (1U << 0)
};

enum class present_mode_khr : std::uint32_t
{
    immediate_khr = 0,
    mailbox_khr = 1,
    fifo_khr = 2,
...
enum class color_space_khr : std::uint32_t
{
    srgb_nonlinear_khr = 0,
    space_srgb_nonlinear_khr [[deprecated]] = 0
};

enum class display_plane_alpha_flag_bits_khr : std::uint32_t
{
    opaque_bit_khr = (1U << 0),
    global_bit_khr = (1U << 1),
...
enum class composite_alpha_flag_bits_khr : std::uint32_t
{
    opaque_bit_khr = (1U << 0),
...
enum class surface_transform_flag_bits_khr : std::uint32_t
{
...
enum class display_surface_stereo_type_nv : std::uint32_t
{
    one_nv = 0,
    onboard_din_nv = 1,
    hdmi_3d_nv = 2,
...
enum class swapchain_image_usage_flag_bits_android : std::uint32_t
{
    shared_bit_android = (1U << 0)
};

enum class time_domain_khr : std::uint32_t
{
    device_khr = 0,
...
enum class debug_report_flag_bits_ext : std::uint32_t
{
...
enum class debug_report_object_type_ext : std::uint32_t
{
    unknown_ext = 0,
    instance_ext = 1,
    ...
    debug_report_ext [[deprecated]] = 28,
    display_khr_ext = 29,
    display_mode_khr_ext = 30,
    validation_cache_ext_ext = 33,
    validation_cache_ext [[deprecated]] = 33
};

enum class device_memory_report_event_type_ext : std::uint32_t
{
    allocate_ext = 0,
    free_ext = 1,
    import_ext = 2,
...
enum class rasterization_order_amd : std::uint32_t
{
    strict_amd = 0,
    relaxed_amd = 1
};

enum class external_memory_handle_type_flag_bits_nv : std::uint32_t
{
...
enum class external_memory_feature_flag_bits_nv : std::uint32_t
{
...
enum class cluster_acceleration_structure_index_format_flag_bits_nv : std::uint32_t
{
    i8bit_nv = (1U << 0),
    i16bit_nv = (1U << 1),
    i32bit_nv = (1U << 2)
...
enum class cluster_acceleration_structure_type_nv : std::uint32_t
{
...
enum class cluster_acceleration_structure_op_type_nv : std::uint32_t
{
    move_objects_nv = 0,
...
enum class cluster_acceleration_structure_op_mode_nv : std::uint32_t
{
...
enum class cluster_acceleration_structure_cluster_flag_bits_nv : std::uint32_t
{
    allow_disable_opacity_micromaps_nv = (1U << 0)
};

enum class cluster_acceleration_structure_geometry_flag_bits_nv : std::uint32_t
{
...
enum class cluster_acceleration_structure_address_resolution_flag_bits_nv : std::uint32_t
{
    none_nv = 0,
...
enum class validation_check_ext : std::uint32_t
{
    all_ext = 0,
    shaders_ext = 1
};

enum class validation_feature_enable_ext : std::uint32_t
{
    gpu_assisted_ext = 0,
...
enum class validation_feature_disable_ext : std::uint32_t
{
    all_ext = 0,
    shaders_ext = 1,
    thread_safety_ext = 2,
...
enum class layer_setting_type_ext : std::uint32_t
{
    bool32_ext = 0,
    int32_ext = 1,
    int64_ext = 2,
...
enum class subgroup_feature_flag_bits : std::uint32_t
{
    basic_bit = (1U << 0),
    vote_bit = (1U << 1),
    arithmetic_bit = (1U << 2),
...
enum class indirect_commands_layout_usage_flag_bits_nv : std::uint32_t
{
...
enum class indirect_state_flag_bits_nv : std::uint32_t
{
    frontface_bit_nv = (1U << 0)
};

enum class indirect_commands_token_type_nv : std::uint32_t
{
    shader_group_nv = 0,
    state_flags_nv = 1,
    index_buffer_nv = 2,
...
enum class private_data_slot_create_flag_bits : std::uint32_t
{
};

enum class descriptor_set_layout_create_flag_bits : std::uint32_t
{
};

enum class external_memory_handle_type_flag_bits : std::uint32_t
{
    opaque_fd_bit = (1U << 0),
...
enum class external_memory_feature_flag_bits : std::uint32_t
{
...
enum class external_semaphore_handle_type_flag_bits : std::uint32_t
{
    opaque_fd_bit = (1U << 0),
    opaque_win32_bit = (1U << 1),
    opaque_win32_kmt_bit = (1U << 2),
...
enum class external_semaphore_feature_flag_bits : std::uint32_t
{
    exportable_bit = (1U << 0),
    importable_bit = (1U << 1)
};

enum class semaphore_import_flag_bits : std::uint32_t
{
    temporary_bit = (1U << 0)
};

enum class external_fence_handle_type_flag_bits : std::uint32_t
{
    opaque_fd_bit = (1U << 0),
    opaque_win32_bit = (1U << 1),
    opaque_win32_kmt_bit = (1U << 2),
...
enum class external_fence_feature_flag_bits : std::uint32_t
{
    exportable_bit = (1U << 0),
    importable_bit = (1U << 1)
};

enum class fence_import_flag_bits : std::uint32_t
{
    temporary_bit = (1U << 0)
};

enum class surface_counter_flag_bits_ext : std::uint32_t
{
    vblank_bit_ext = (1U << 0),
    vblank_ext [[deprecated]] = (1U << 0)
};

enum class display_power_state_ext : std::uint32_t
{
    off_ext = 0,
    suspend_ext = 1,
    on_ext = 2
...
enum class device_event_type_ext : std::uint32_t
{
    display_hotplug_ext = 0
};

enum class display_event_type_ext : std::uint32_t
{
    first_pixel_out_ext = 0
};

enum class peer_memory_feature_flag_bits : std::uint32_t
{
    copy_src_bit = (1U << 0),
    copy_dst_bit = (1U << 1),
...
enum class memory_allocate_flag_bits : std::uint32_t
{
    device_mask_bit = (1U << 0)
};

enum class device_group_present_mode_flag_bits_khr : std::uint32_t
{
    local_bit_khr = (1U << 0),
    remote_bit_khr = (1U << 1),
    sum_bit_khr = (1U << 2),
...
enum class swapchain_create_flag_bits_khr : std::uint32_t
{
};

enum class viewport_coordinate_swizzle_nv : std::uint32_t
{
    positive_x_nv = 0,
    egative_x_nv = 1,
    positive_y_nv = 2,
...
enum class discard_rectangle_mode_ext : std::uint32_t
{
    inclusive_ext = 0,
    clusive_ext = 1
};

enum class subpass_description_flag_bits : std::uint32_t
{
};

enum class point_clipping_behavior : std::uint32_t
{
    all_clip_planes = 0,
    user_clip_planes_only = 1
};

enum class sampler_reduction_mode : std::uint32_t
{
    weighted_average = 0,
    min = 1,
    max = 2
...
enum class tessellation_domain_origin : std::uint32_t
{
    upper_left = 0,
    lower_left = 1
};

enum class sampler_ycbcr_model_conversion : std::uint32_t
{
    rgb_identity = 0,
    ycbcr_identity = 1,
    ycbcr_709 = 2,
...
enum class sampler_ycbcr_range : std::uint32_t
{
    itu_full = 0,
    itu_narrow = 1
};

enum class chroma_location : std::uint32_t
{
    cosited_even = 0,
    midpoint = 1
};

enum class blend_overlap_ext : std::uint32_t
{
    uncorrelated_ext = 0,
    disjoint_ext = 1,
    conjoint_ext = 2
...
enum class coverage_modulation_mode_nv : std::uint32_t
{
    one_nv = 0,
    rgb_nv = 1,
    alpha_nv = 2,
...
enum class coverage_reduction_mode_nv : std::uint32_t
{
    merge_nv = 0,
    truncate_nv = 1
};

enum class validation_cache_header_version_ext : std::uint32_t
{
    one_ext = 1
};

enum class shader_info_type_amd : std::uint32_t
{
    statistics_amd = 0,
    binary_amd = 1,
    disassembly_amd = 2
...
enum class queue_global_priority : std::uint32_t
{
    low = 128,
    medium = 256,
    high = 512,
...
enum class debug_utils_message_severity_flag_bits_ext : std::uint32_t
{
...
enum class debug_utils_message_type_flag_bits_ext : std::uint32_t
{
...
enum class conservative_rasterization_mode_ext : std::uint32_t
{
    disabled_ext = 0,
    overestimate_ext = 1,
    underestimate_ext = 2
...
enum class descriptor_binding_flag_bits : std::uint32_t
{
...
enum class vendor_id : std::uint32_t
{
    khronos = 0x10000,
    viv = 0x10001,
    vsi = 0x10002,
...
enum class conditional_rendering_flag_bits_ext : std::uint32_t
{
    inverted_bit_ext = (1U << 0)
};

enum class resolve_mode_flag_bits : std::uint32_t
{
    none = 0,
...
enum class shading_rate_palette_entry_nv : std::uint32_t
{
    o_invocations_nv = 0,
...
enum class coarse_sample_order_type_nv : std::uint32_t
{
    default_nv = 0,
    custom_nv = 1,
    pixel_major_nv = 2,
...
enum class geometry_instance_flag_bits_khr : std::uint32_t
{
...
enum class geometry_flag_bits_khr : std::uint32_t
{
    opaque_bit_khr = (1U << 0),
    no_duplicate_any_hit_invocation_bit_khr = (1U << 1)
};

enum class build_acceleration_structure_flag_bits_khr : std::uint32_t
{
...
enum class acceleration_structure_create_flag_bits_khr : std::uint32_t
{
    device_address_capture_replay_bit_khr = (1U << 0)
};

enum class copy_acceleration_structure_mode_khr : std::uint32_t
{
    clone_khr = 0,
    compact_khr = 1
};

enum class build_acceleration_structure_mode_khr : std::uint32_t
{
    build_khr = 0,
    update_khr = 1
};

enum class acceleration_structure_type_khr : std::uint32_t
{
    top_level_khr = 0,
    bottom_level_khr = 1,
    generic_khr = 2
...
enum class geometry_type_khr : std::uint32_t
{
    triangles_khr = 0,
    aabbs_khr = 1,
    instances_khr = 2
...
enum class acceleration_structure_memory_requirements_type_nv : std::uint32_t
{
    object_nv = 0,
    build_scratch_nv = 1,
    update_scratch_nv = 2
...
enum class acceleration_structure_build_type_khr : std::uint32_t
{
    host_khr = 0,
    device_khr = 1,
...
enum class ray_tracing_shader_group_type_khr : std::uint32_t
{
    general_khr = 0,
...
enum class acceleration_structure_compatibility_khr : std::uint32_t
{
    compatible_khr = 0,
    incompatible_khr = 1
};

enum class shader_group_shader_khr : std::uint32_t
{
    general_khr = 0,
    closest_hit_khr = 1,
    any_hit_khr = 2,
...
enum class memory_overallocation_behavior_amd : std::uint32_t
{
    default_amd = 0,
    llowed_amd = 1,
    disallowed_amd = 2
...
enum class framebuffer_create_flag_bits : std::uint32_t
{
};

enum class query_pool_create_flag_bits : std::uint32_t
{
};

enum class device_diagnostics_config_flag_bits_nv : std::uint32_t
{
...
enum class pipeline_creation_feedback_flag_bits : std::uint32_t
{
    valid_bit = (1U << 0),
...
enum class full_screen_exclusive_ext : std::uint32_t
{
    default_ext = 0,
    allowed_ext = 1,
    disallowed_ext = 2,
...
enum class performance_counter_scope_khr : std::uint32_t
{
    command_buffer_khr = 0,
    render_pass_khr = 1,
    command_khr = 2,
    query_scope_command_buffer_khr [[deprecated]] = 0,
    query_scope_render_pass_khr [[deprecated]] = 1,
    query_scope_command_khr [[deprecated]] = 2
};

enum class memory_decompression_method_flag_bits_ext : std::uint64_t
{
    gdeflate_1_0_bit_ext = (1ULL << 0),
    gdeflate_1_0_bit_nv = (1ULL << 0)
};

enum class performance_counter_unit_khr : std::uint32_t
{
    generic_khr = 0,
    percentage_khr = 1,
    nanoseconds_khr = 2,
...
enum class performance_counter_storage_khr : std::uint32_t
{
    int32_khr = 0,
    int64_khr = 1,
    uint32_khr = 2,
...
enum class performance_counter_description_flag_bits_khr : std::uint32_t
{
    performance_impacting_bit_khr = (1U << 0),
    performance_impacting_khr [[deprecated]] = (1U << 0),
    concurrently_impacted_bit_khr = (1U << 1),
    concurrently_impacted_khr [[deprecated]] = (1U << 1)
};

enum class acquire_profiling_lock_flag_bits_khr : std::uint32_t
{
};

enum class shader_core_properties_flag_bits_amd : std::uint32_t
{
};

enum class refresh_object_flag_bits_khr : std::uint32_t
{
};

enum class performance_configuration_type_intel : std::uint32_t
{
    command_queue_metrics_discovery_activated_intel = 0
};

enum class query_pool_sampling_mode_intel : std::uint32_t
{
    manual_intel = 0
};

enum class performance_override_type_intel : std::uint32_t
{
    null_hardware_intel = 0,
    flush_gpu_caches_intel = 1
};

enum class performance_parameter_type_intel : std::uint32_t
{
    hw_counters_supported_intel = 0,
    stream_marker_valid_bits_intel = 1
};

enum class performance_value_type_intel : std::uint32_t
{
    uint32_intel = 0,
    uint64_intel = 1,
    float_intel = 2,
...
enum class shader_float_controls_independence : std::uint32_t
{
    i32_bit_only = 0,
    all = 1,
    none = 2
...
enum class pipeline_executable_statistic_format_khr : std::uint32_t
{
    bool32_khr = 0,
    int64_khr = 1,
    uint64_khr = 2,
...
enum class line_rasterization_mode : std::uint32_t
{
    idefault = 0,
    rectangular = 1,
    bresenham = 2,
...
enum class shader_module_create_flag_bits : std::uint32_t
{
};

enum class pipeline_compiler_control_flag_bits_amd : std::uint32_t
{
};

enum class fault_level : std::uint32_t
{
    unassigned = 0,
    critical = 1,
    recoverable = 2,
...
enum class fault_type : std::uint32_t
{
    invalid = 0,
    unassigned = 1,
    implementation = 2,
...
enum class fault_query_behavior : std::uint32_t
{
    get_and_clear_all_faults = 0
};

enum class tool_purpose_flag_bits : std::uint32_t
{
    validation_bit = (1U << 0),
    profiling_bit = (1U << 1),
    tracing_bit = (1U << 2),
...
enum class pipeline_match_control : std::uint32_t
{
    application_uuid_exact_match = 0
};

enum class fragment_shading_rate_combiner_op_khr : std::uint32_t
{
    eep_khr = 0,
    replace_khr = 1,
    min_khr = 2,
...
enum class fragment_shading_rate_nv : std::uint32_t
{
...
enum class fragment_shading_rate_type_nv : std::uint32_t
{
    fragment_size_nv = 0,
    enums_nv = 1
};

enum class subpass_merge_status_ext : std::uint32_t
{
    merged_ext = 0,
    disallowed_ext = 1,
...
enum class access_flag_bits2 : std::uint64_t
{
    i2_none = 0,
...
enum class pipeline_stage_flag_bits2 : std::uint64_t
{
    i2_none = 0,
...
enum class submit_flag_bits : std::uint32_t
{
    protected_bit = (1U << 0)
};

enum class event_create_flag_bits : std::uint32_t
{
};

enum class pipeline_layout_create_flag_bits : std::uint32_t
{
};

enum class sci_sync_client_type_nv : std::uint32_t
{
    signaler_nv = 0,
    waiter_nv = 1,
...
enum class sci_sync_primitive_type_nv : std::uint32_t
{
    fence_nv = 0,
    semaphore_nv = 1
};

enum class provoking_vertex_mode_ext : std::uint32_t
{
    first_vertex_ext = 0,
    last_vertex_ext = 1
};

enum class pipeline_cache_validation_version : std::uint32_t
{
    safety_critical_one = 1
};

enum class acceleration_structure_motion_instance_type_nv : std::uint32_t
{
    static_nv = 0,
    matrix_motion_nv = 1,
    srt_motion_nv = 2
...
enum class pipeline_color_blend_state_create_flag_bits : std::uint32_t
{
};

enum class pipeline_depth_stencil_state_create_flag_bits : std::uint32_t
{
};

enum class graphics_pipeline_library_flag_bits_ext : std::uint32_t
{
...
enum class rendering_attachment_flag_bits_khr : std::uint32_t
{
};

enum class resolve_image_flag_bits_khr : std::uint32_t
{
};

enum class device_address_binding_flag_bits_ext : std::uint32_t
{
    internal_object_bit_ext = (1U << 0)
};

enum class device_address_binding_type_ext : std::uint32_t
{
    bind_ext = 0,
    unbind_ext = 1
};

enum class frame_boundary_flag_bits_ext : std::uint32_t
{
    rame_end_bit_ext = (1U << 0)
};

enum class present_scaling_flag_bits_khr : std::uint32_t
{
...
enum class present_gravity_flag_bits_khr : std::uint32_t
{
    min_bit_khr = (1U << 0),
    min_bit_ext = (1U << 0),
    max_bit_khr = (1U << 1),
...
enum class physical_device_scheduling_controls_flag_bits_arm : std::uint64_t
{
    shader_core_count_arm = (1ULL << 0)
};

enum class present_stage_flag_bits_ext : std::uint32_t
{
...
enum class past_presentation_timing_flag_bits_ext : std::uint32_t
{
    allow_partial_results_bit_ext = (1U << 0),
    allow_out_of_order_results_bit_ext = (1U << 1)
};

enum class present_timing_info_flag_bits_ext : std::uint32_t
{
    present_at_relative_time_bit_ext = (1U << 0),
    present_at_nearest_refresh_cycle_bit_ext = (1U << 1)
};

enum class video_codec_operation_flag_bits_khr : std::uint32_t
{
    none_khr = 0
};

enum class video_chroma_subsampling_flag_bits_khr : std::uint32_t
{
    invalid_khr = 0,
...
enum class video_component_bit_depth_flag_bits_khr : std::uint32_t
{
    invalid_khr = 0,
    i8_bit_khr = (1U << 0),
    i10_bit_khr = (1U << 2),
...
enum class video_capability_flag_bits_khr : std::uint32_t
{
    protected_content_bit_khr = (1U << 0),
    separate_reference_images_bit_khr = (1U << 1)
};

enum class video_session_create_flag_bits_khr : std::uint32_t
{
    protected_content_bit_khr = (1U << 0)
};

enum class video_session_parameters_create_flag_bits_khr : std::uint32_t
{
};

enum class video_decode_h264_picture_layout_flag_bits_khr : std::uint32_t
{
    progressive_khr = 0,
...
enum class video_coding_control_flag_bits_khr : std::uint32_t
{
    reset_bit_khr = (1U << 0)
};

enum class query_result_status_khr : std::int32_t
{
    error_khr = -1,
    not_ready_khr = 0,
    complete_khr = 1
...
enum class video_decode_usage_flag_bits_khr : std::uint32_t
{
    default_khr = 0,
...
enum class video_decode_capability_flag_bits_khr : std::uint32_t
{
    dpb_and_output_coincide_bit_khr = (1U << 0),
    dpb_and_output_distinct_bit_khr = (1U << 1)
};

enum class video_encode_flag_bits_khr : std::uint32_t
{
};

enum class video_encode_usage_flag_bits_khr : std::uint32_t
{
    default_khr = 0,
    transcoding_bit_khr = (1U << 0),
...
enum class video_encode_content_flag_bits_khr : std::uint32_t
{
    default_khr = 0,
    camera_bit_khr = (1U << 0),
...
enum class video_encode_tuning_mode_khr : std::uint32_t
{
    default_khr = 0,
    high_quality_khr = 1,
    low_latency_khr = 2,
...
enum class video_encode_capability_flag_bits_khr : std::uint32_t
{
    preceding_externally_encoded_bytes_bit_khr = (1U << 0),
    insufficient_bitstream_buffer_range_detection_bit_khr = (1U << 1)
};

enum class video_encode_feedback_flag_bits_khr : std::uint32_t
{
...
enum class video_encode_rate_control_mode_flag_bits_khr : std::uint32_t
{
    default_khr = 0,
...
enum class video_encode_intra_refresh_mode_flag_bits_khr : std::uint32_t
{
    none_khr = 0,
...
enum class video_encode_h264_capability_flag_bits_khr : std::uint32_t
{
...
enum class video_encode_h264_std_flag_bits_khr : std::uint32_t
{
...
enum class video_encode_h264_rate_control_flag_bits_khr : std::uint32_t
{
...
enum class host_image_copy_flag_bits : std::uint32_t
{
    memcpy_bit = (1U << 0),
    memcpy [[deprecated]] = (1U << 0)
};

enum class partitioned_acceleration_structure_op_type_nv : std::uint32_t
{
    write_instance_nv = 0,
...
enum class partitioned_acceleration_structure_instance_flag_bits_nv : std::uint32_t
{
...
enum class image_format_constraints_flag_bits_fuchsia : std::uint32_t
{
};

enum class image_constraints_info_flag_bits_fuchsia : std::uint32_t
{
...
enum class format_feature_flag_bits2 : std::uint64_t
{
...
enum class rendering_flag_bits : std::uint32_t
{
...
enum class video_encode_h265_capability_flag_bits_khr : std::uint32_t
{
    hrd_compliance_bit_khr = (1U << 0),
    prediction_weight_table_generated_bit_khr = (1U << 1),
...
enum class video_encode_h265_std_flag_bits_khr : std::uint32_t
{
    separate_color_plane_flag_set_bit_khr = (1U << 0),
...
enum class video_encode_h265_rate_control_flag_bits_khr : std::uint32_t
{
    attempt_hrd_compliance_bit_khr = (1U << 0),
    regular_gop_bit_khr = (1U << 1),
    reference_pattern_flat_bit_khr = (1U << 2),
...
enum class video_encode_h265_ctb_size_flag_bits_khr : std::uint32_t
{
    i16_bit_khr = (1U << 0),
    i32_bit_khr = (1U << 1),
    i64_bit_khr = (1U << 2)
...
enum class video_encode_h265_transform_block_size_flag_bits_khr : std::uint32_t
{
    i4_bit_khr = (1U << 0),
    i8_bit_khr = (1U << 1),
    i16_bit_khr = (1U << 2),
...
enum class video_encode_av1_capability_flag_bits_khr : std::uint32_t
{
...
enum class video_encode_av1_std_flag_bits_khr : std::uint32_t
{
...
enum class video_encode_av1_rate_control_flag_bits_khr : std::uint32_t
{
...
enum class video_encode_av1_superblock_size_flag_bits_khr : std::uint32_t
{
    i64_bit_khr = (1U << 0),
    i128_bit_khr = (1U << 1)
};

enum class video_encode_av1_prediction_mode_khr : std::uint32_t
{
    intra_only_khr = 0,
...
enum class video_encode_av1_rate_control_group_khr : std::uint32_t
{
    intra_khr = 0,
    predictive_khr = 1,
    bipredictive_khr = 2
...
enum class export_metal_object_type_flag_bits_ext : std::uint32_t
{
...
enum class instance_create_flag_bits : std::uint32_t
{
};

enum class image_compression_flag_bits_ext : std::uint32_t
{
    default_ext = 0,
...
enum class image_compression_fixed_rate_flag_bits_ext : std::uint32_t
{
    none_ext = 0,
    i1bpc_bit_ext = (1U << 0),
    i2bpc_bit_ext = (1U << 1),
...
enum class pipeline_robustness_buffer_behavior : std::uint32_t
{
    device_default = 0,
    disabled = 1,
...
enum class pipeline_robustness_image_behavior : std::uint32_t
{
    device_default = 0,
    disabled = 1,
...
enum class optical_flow_grid_size_flag_bits_nv : std::uint32_t
{
    unknown_nv = 0,
    i1x1_bit_nv = (1U << 0),
    i2x2_bit_nv = (1U << 1),
...
enum class optical_flow_usage_flag_bits_nv : std::uint32_t
{
    unknown_nv = 0,
    input_bit_nv = (1U << 0),
    output_bit_nv = (1U << 1),
...
enum class optical_flow_performance_level_nv : std::uint32_t
{
    unknown_nv = 0,
    slow_nv = 1,
    medium_nv = 2,
...
enum class optical_flow_session_binding_point_nv : std::uint32_t
{
    unknown_nv = 0,
    input_nv = 1,
    reference_nv = 2,
...
enum class optical_flow_session_create_flag_bits_nv : std::uint32_t
{
...
enum class optical_flow_execute_flag_bits_nv : std::uint32_t
{
    disable_temporal_hints_bit_nv = (1U << 0)
};

enum class micromap_type_ext : std::uint32_t
{
    opacity_micromap_ext = 0
};

enum class build_micromap_flag_bits_ext : std::uint32_t
{
...
enum class micromap_create_flag_bits_ext : std::uint32_t
{
    device_address_capture_replay_bit_ext = (1U << 0)
};

enum class copy_micromap_mode_ext : std::uint32_t
{
    clone_ext = 0,
    serialize_ext = 1,
    deserialize_ext = 2,
...
enum class build_micromap_mode_ext : std::uint32_t
{
    build_ext = 0
};

enum class opacity_micromap_format_ext : std::uint32_t
{
    i2_state_ext = 1,
    i4_state_ext = 2
};

enum class opacity_micromap_special_index_ext : std::int32_t
{
...
enum class depth_bias_representation_ext : std::uint32_t
{
...
enum class device_fault_address_type_ext : std::uint32_t
{
    none_ext = 0,
    read_invalid_ext = 1,
    write_invalid_ext = 2,
...
enum class device_fault_vendor_binary_header_version_ext : std::uint32_t
{
    one_ext = 1
};

enum class indirect_commands_layout_usage_flag_bits_ext : std::uint32_t
{
    explicit_preprocess_bit_ext = (1U << 0),
    unordered_sequences_bit_ext = (1U << 1)
};

enum class indirect_execution_set_info_type_ext : std::uint32_t
{
    pipelines_ext = 0,
    shader_objects_ext = 1
};

enum class indirect_commands_input_mode_flag_bits_ext : std::uint32_t
{
    vulkan_index_buffer_ext = (1U << 0),
    dxgi_index_buffer_ext = (1U << 1)
};

enum class indirect_commands_token_type_ext : std::uint32_t
{
    ecution_set_ext = 0,
    push_constant_ext = 1,
...
enum class displacement_micromap_format_nv : std::uint32_t
{
...
enum class shader_create_flag_bits_ext : std::uint32_t
{
    link_stage_bit_ext = (1U << 0)
};

enum class shader_code_type_ext : std::uint32_t
{
    binary_ext = 0,
    spirv_ext = 1
};

enum class scope_khr : std::uint32_t
{
    device_khr = 1,
    workgroup_khr = 2,
    subgroup_khr = 3,
...
enum class component_type_khr : std::uint32_t
{
    float16_khr = 0,
    float32_khr = 1,
    float64_khr = 2,
...
enum class cubic_filter_weights_qcom : std::uint32_t
{
    catmull_rom_qcom = 0,
...
enum class block_match_window_compare_mode_qcom : std::uint32_t
{
    min_qcom = 0,
    max_qcom = 1
};

enum class physical_device_layered_api_khr : std::uint32_t
{
    vulkan_khr = 0,
    d3d12_khr = 1,
    metal_khr = 2,
...
enum class layered_driver_underlying_api_msft : std::uint32_t
{
    none_msft = 0,
    d3d12_msft = 1
};

enum class latency_marker_nv : std::uint32_t
{
...
enum class out_of_band_queue_type_nv : std::uint32_t
{
    render_nv = 0,
    present_nv = 1
};

enum class memory_unmap_flag_bits : std::uint32_t
{
};

enum class compressed_triangle_format_amdx : std::uint32_t
{
    dgf1_amdx = 0
};

enum class wayland_surface_create_flag_bits_khr : std::uint32_t
{
};

enum class depth_clamp_mode_ext : std::uint32_t
{
    viewport_range_ext = 0,
    user_defined_range_ext = 1
};

enum class access_flag_bits3_khr : std::uint64_t
{
    i3_none_khr = 0
};

enum class tile_shading_render_pass_flag_bits_qcom : std::uint32_t
{
    enable_bit_qcom = (1U << 0),
    per_tile_execution_bit_qcom = (1U << 1)
};

enum class cooperative_vector_matrix_layout_nv : std::uint32_t
{
    row_major_nv = 0,
    column_major_nv = 1,
...
enum class address_copy_flag_bits_khr : std::uint32_t
{
...
enum class tensor_create_flag_bits_arm : std::uint64_t
{
    mutable_format_bit_arm = (1ULL << 0),
    protected_bit_arm = (1ULL << 1)
};

enum class tensor_usage_flag_bits_arm : std::uint64_t
{
...
enum class tensor_tiling_arm : std::uint32_t
{
    optimal_arm = 0,
    linear_arm = 1
};

enum class tensor_view_create_flag_bits_arm : std::uint64_t
{
};

enum class default_vertex_attribute_value_khr : std::uint32_t
{
    zero_zero_zero_zero_khr = 0,
    zero_zero_zero_one_khr = 1
};

enum class data_graph_pipeline_session_create_flag_bits_arm : std::uint64_t
{
    protected_bit_arm = (1ULL << 0)
};

enum class data_graph_pipeline_session_bind_point_arm : std::uint32_t
{
    transient_arm = 0
};

enum class data_graph_pipeline_session_bind_point_type_arm : std::uint32_t
{
    memory_arm = 0
};

enum class data_graph_pipeline_property_arm : std::uint32_t
{
    creation_log_arm = 0,
    identifier_arm = 1
};

enum class data_graph_pipeline_dispatch_flag_bits_arm : std::uint64_t
{
};

enum class physical_device_data_graph_processing_engine_type_arm : std::uint32_t
{
    default_arm = 0
};

enum class physical_device_data_graph_operation_type_arm : std::uint32_t
{
    spirv_extended_instruction_set_arm = 0
};

enum class data_graph_model_cache_type_qcom : std::uint32_t
{
    generic_binary_qcom = 0
};

enum class video_encode_rgb_model_conversion_flag_bits_valve : std::uint32_t
{
...
enum class video_encode_rgb_range_compression_flag_bits_valve : std::uint32_t
{
    ull_range_bit_valve = (1U << 0),
    narrow_range_bit_valve = (1U << 1)
};

enum class video_encode_rgb_chroma_offset_flag_bits_valve : std::uint32_t
{
    cosited_even_bit_valve = (1U << 0),
    midpoint_bit_valve = (1U << 1)
};

enum class swapchain_image_usage_flag_bits_ohos : std::uint32_t
{
    shared_bit_ohos = (1U << 0)
};

enum class descriptor_mapping_source_ext : std::uint32_t
{
...
enum class spirv_resource_type_flag_bits_ext : std::uint32_t
{
    all_ext = 0x7FFFFFFF,

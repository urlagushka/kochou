...
namespace ktl::api
{
    ...
    enum class device_fault_flag_bits_khr
        : ktl::u32
    {
    ...
    enum class device_fault_address_type_khr
        : ktl::u32
    {
        v_none_khr                        = 0,
    ...
    enum class device_fault_vendor_binary_header_version_khr
        : ktl::u32
    {
        v_one_khr = 1,
        v_one_ext = 1
    ...
    enum class address_command_flag_bits_khr
        : ktl::u32
    {

from headers import make_constants_header, make_enums_header, make_handles_header, make_structs_header, make_bitmasks_header
...
bitmasks = extract_bitmasks(ROOT)
...
make_bitmasks_header("bitmasks.hpp", bitmasks)

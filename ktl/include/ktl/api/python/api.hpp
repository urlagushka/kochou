...
enum class structure_type : ktl::u32
{
    ...
    v_physical_device_texture_compression_astc_hdr_features_ext =
        v_physical_device_texture_compression_astc_hdr_features,
    ...
    v_descriptor_set_variable_descriptor_count_allocate_info_ext =
        v_descriptor_set_variable_descriptor_count_allocate_info,
    v_descriptor_set_variable_descriptor_count_layout_support_ext =
        v_descriptor_set_variable_descriptor_count_layout_support,
    ...
    v_physical_device_shader_subgroup_extended_types_features_khr =
        v_physical_device_shader_subgroup_extended_types_features,
    ...
    v_physical_device_compute_shader_derivatives_features_nv =
        v_physical_device_compute_shader_derivatives_features_khr,
    v_physical_device_fragment_shader_barycentric_features_nv =
        v_physical_device_fragment_shader_barycentric_features_khr,
    ...
    v_pipeline_shader_stage_required_subgroup_size_create_info_ext =
        v_pipeline_shader_stage_required_subgroup_size_create_info,
    v_physical_device_subgroup_size_control_features_ext = v_physical_device_subgroup_size_control_features,
    v_physical_device_dynamic_rendering_local_read_features_khr =
        v_physical_device_dynamic_rendering_local_read_features,
    ...
    v_physical_device_separate_depth_stencil_layouts_features_khr =
        v_physical_device_separate_depth_stencil_layouts_features,
    ...
    v_physical_device_uniform_buffer_standard_layout_features_khr =
        v_physical_device_uniform_buffer_standard_layout_features,
    ...
    v_physical_device_shader_demote_to_helper_invocation_features_ext =
        v_physical_device_shader_demote_to_helper_invocation_features,
    v_physical_device_shader_integer_dot_product_features_khr = v_physical_device_shader_integer_dot_product_features,
    v_physical_device_shader_integer_dot_product_properties_khr =
        v_physical_device_shader_integer_dot_product_properties,
    ...
    v_physical_device_pipeline_creation_cache_control_features_ext =
        v_physical_device_pipeline_creation_cache_control_features,
    ...
    v_physical_device_zero_initialize_workgroup_memory_features_khr =
        v_physical_device_zero_initialize_workgroup_memory_features,
    ...
    v_physical_device_rasterization_order_attachment_access_features_arm =
        v_physical_device_rasterization_order_attachment_access_features_ext,
    ...
    v_physical_device_fragment_density_map_offset_features_qcom =
        v_physical_device_fragment_density_map_offset_features_ext,
    v_physical_device_fragment_density_map_offset_properties_qcom =
        v_physical_device_fragment_density_map_offset_properties_ext,
...
enum class pipeline_create_flag_bits : ktl::u32
{
    ...
    v_rasterization_state_create_fragment_density_map_attachment_bit_ext [[deprecated]] =
...
enum class format_feature_flag_bits : ktl::u32
{
    ...
    v_sampled_image_ycbcr_conversion_separate_reconstruction_filter_bit_khr =
        v_sampled_image_ycbcr_conversion_separate_reconstruction_filter_bit,
    v_sampled_image_ycbcr_conversion_chroma_reconstruction_explicit_bit_khr =
        v_sampled_image_ycbcr_conversion_chroma_reconstruction_explicit_bit,
    v_sampled_image_ycbcr_conversion_chroma_reconstruction_explicit_forceable_bit_khr =
        v_sampled_image_ycbcr_conversion_chroma_reconstruction_explicit_forceable_bit,
    v_disjoint_bit_khr               = v_disjoint_bit,
...
enum class format_feature_flag_bits2 : ktl::u64
{
    ...
    v_2_sampled_image_ycbcr_conversion_separate_reconstruction_filter_bit_khr =
        v_2_sampled_image_ycbcr_conversion_separate_reconstruction_filter_bit,
    v_2_sampled_image_ycbcr_conversion_chroma_reconstruction_explicit_bit_khr =
        v_2_sampled_image_ycbcr_conversion_chroma_reconstruction_explicit_bit,
    v_2_sampled_image_ycbcr_conversion_chroma_reconstruction_explicit_forceable_bit_khr =
        v_2_sampled_image_ycbcr_conversion_chroma_reconstruction_explicit_forceable_bit,
...
{
    ktl::api::structure_type type =
        ktl::api::structure_type::v_physical_device_scheduling_controls_dispatch_parameters_properties_arm;
    void *   next = {};

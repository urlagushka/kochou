...
namespace ktl::api
{
    ...
    enum class video_codec_operation_flag_bits_khr : ktl::u32
    {
        v_none_khr = 0
    };

    enum class video_chroma_subsampling_flag_bits_khr : ktl::u32
    {
        v_invalid_khr        = 0,
    ...
    enum class video_component_bit_depth_flag_bits_khr : ktl::u32
    {
        v_invalid_khr = 0,
        v_8_bit_khr   = (1U << 0),
        v_10_bit_khr  = (1U << 2),
    ...
    enum class video_capability_flag_bits_khr : ktl::u32
    {
        v_protected_content_bit_khr         = (1U << 0),
        v_separate_reference_images_bit_khr = (1U << 1)
    };

    enum class video_session_create_flag_bits_khr : ktl::u32
    {
        v_protected_content_bit_khr = (1U << 0)
    };

    enum class video_session_parameters_create_flag_bits_khr : ktl::u32
    {
    };

    enum class video_decode_h264picture_layout_flag_bits_khr : ktl::u32
    {
        v_picture_layout_progressive_khr                      = 0,
        v_picture_layout_interlaced_interleaved_lines_bit_khr = (1U << 0),
        v_picture_layout_interlaced_separate_planes_bit_khr   = (1U << 1)
    };

    enum class video_coding_control_flag_bits_khr : ktl::u32
    {
    ...
    enum class video_decode_usage_flag_bits_khr : ktl::u32
    {
        v_default_khr         = 0,
    ...
    enum class video_decode_capability_flag_bits_khr : ktl::u32
    {
        v_dpb_and_output_coincide_bit_khr = (1U << 0),
        v_dpb_and_output_distinct_bit_khr = (1U << 1)
    };

    enum class video_encode_flag_bits_khr : ktl::u32
    {
    };

    enum class video_encode_usage_flag_bits_khr : ktl::u32
    {
        v_default_khr          = 0,
        v_transcoding_bit_khr  = (1U << 0),
    ...
    enum class video_encode_content_flag_bits_khr : ktl::u32
    {
        v_default_khr      = 0,
    ...
    enum class video_encode_tuning_mode_khr : ktl::u32
    {
        v_default_khr           = 0,
    ...
    enum class video_encode_capability_flag_bits_khr : ktl::u32
    {
        v_preceding_externally_encoded_bytes_bit_khr            = (1U << 0),
        v_insufficient_bitstream_buffer_range_detection_bit_khr = (1U << 1)
    };

    enum class video_encode_feedback_flag_bits_khr : ktl::u32
    {
    ...
    enum class video_encode_rate_control_mode_flag_bits_khr : ktl::u32
    {
        v_default_khr      = 0,
    ...
    enum class video_encode_intra_refresh_mode_flag_bits_khr : ktl::u32
    {
        v_none_khr                      = 0,
    ...
    enum class video_encode_h264capability_flag_bits_khr : ktl::u32
    {
        v_capability_hrd_compliance_bit_khr                    = (1U << 0),
        v_capability_prediction_weight_table_generated_bit_khr = (1U << 1),
        v_capability_row_unaligned_slice_bit_khr               = (1U << 2),
        v_capability_different_slice_type_bit_khr              = (1U << 3),
        v_capability_b_frame_in_l0_list_bit_khr                = (1U << 4),
        v_capability_b_frame_in_l1_list_bit_khr                = (1U << 5),
        v_capability_per_picture_type_min_max_qp_bit_khr       = (1U << 6),
        v_capability_per_slice_constant_qp_bit_khr             = (1U << 7),
        v_capability_generate_prefix_nalu_bit_khr              = (1U << 8)
    };

    enum class video_encode_h264std_flag_bits_khr : ktl::u32
    {
        v_std_separate_color_plane_flag_set_bit_khr            = (1U << 0),
        v_std_qpprime_y_zero_transform_bypass_flag_set_bit_khr = (1U << 1),
        v_std_scaling_matrix_present_flag_set_bit_khr          = (1U << 2),
        v_std_chroma_qp_index_offset_bit_khr                   = (1U << 3),
        v_std_second_chroma_qp_index_offset_bit_khr            = (1U << 4),
        v_std_pic_init_qp_minus26_bit_khr                      = (1U << 5),
        v_std_weighted_pred_flag_set_bit_khr                   = (1U << 6),
        v_std_weighted_bipred_idc_explicit_bit_khr             = (1U << 7),
        v_std_weighted_bipred_idc_implicit_bit_khr             = (1U << 8),
        v_std_transform_8x8_mode_flag_set_bit_khr              = (1U << 9),
        v_std_direct_spatial_mv_pred_flag_unset_bit_khr        = (1U << 10),
        v_std_entropy_coding_mode_flag_unset_bit_khr           = (1U << 11),
        v_std_entropy_coding_mode_flag_set_bit_khr             = (1U << 12),
        v_std_direct_8x8_inference_flag_unset_bit_khr          = (1U << 13),
        v_std_constrained_intra_pred_flag_set_bit_khr          = (1U << 14),
        v_std_deblocking_filter_disabled_bit_khr               = (1U << 15),
        v_std_deblocking_filter_enabled_bit_khr                = (1U << 16),
        v_std_deblocking_filter_partial_bit_khr                = (1U << 17),
        v_std_slice_qp_delta_bit_khr                           = (1U << 19),
        v_std_different_slice_qp_delta_bit_khr                 = (1U << 20)
    };

    enum class video_encode_h264rate_control_flag_bits_khr : ktl::u32
    {
        v_rate_control_attempt_hrd_compliance_bit_khr        = (1U << 0),
        v_rate_control_regular_gop_bit_khr                   = (1U << 1),
        v_rate_control_reference_pattern_flat_bit_khr        = (1U << 2),
        v_rate_control_reference_pattern_dyadic_bit_khr      = (1U << 3),
        v_rate_control_temporal_layer_pattern_dyadic_bit_khr = (1U << 4)
    };
    ...
    enum class video_encode_h265capability_flag_bits_khr : ktl::u32
    {
        v_capability_hrd_compliance_bit_khr                    = (1U << 0),
        v_capability_prediction_weight_table_generated_bit_khr = (1U << 1),
        v_capability_row_unaligned_slice_segment_bit_khr       = (1U << 2),
        v_capability_different_slice_segment_type_bit_khr      = (1U << 3),
        v_capability_b_frame_in_l0_list_bit_khr                = (1U << 4),
        v_capability_b_frame_in_l1_list_bit_khr                = (1U << 5),
        v_capability_per_picture_type_min_max_qp_bit_khr       = (1U << 6),
        v_capability_per_slice_segment_constant_qp_bit_khr     = (1U << 7),
        v_capability_multiple_tiles_per_slice_segment_bit_khr  = (1U << 8),
        v_capability_multiple_slice_segments_per_tile_bit_khr  = (1U << 9)
    };

    enum class video_encode_h265std_flag_bits_khr : ktl::u32
    {
        v_std_separate_color_plane_flag_set_bit_khr                = (1U << 0),
        v_std_sample_adaptive_offset_enabled_flag_set_bit_khr      = (1U << 1),
        v_std_scaling_list_data_present_flag_set_bit_khr           = (1U << 2),
        v_std_pcm_enabled_flag_set_bit_khr                         = (1U << 3),
        v_std_sps_temporal_mvp_enabled_flag_set_bit_khr            = (1U << 4),
        v_std_init_qp_minus26_bit_khr                              = (1U << 5),
        v_std_weighted_pred_flag_set_bit_khr                       = (1U << 6),
        v_std_weighted_bipred_flag_set_bit_khr                     = (1U << 7),
        v_std_log2_parallel_merge_level_minus2_bit_khr             = (1U << 8),
        v_std_sign_data_hiding_enabled_flag_set_bit_khr            = (1U << 9),
        v_std_transform_skip_enabled_flag_set_bit_khr              = (1U << 10),
        v_std_transform_skip_enabled_flag_unset_bit_khr            = (1U << 11),
        v_std_pps_slice_chroma_qp_offsets_present_flag_set_bit_khr = (1U << 12),
        v_std_transquant_bypass_enabled_flag_set_bit_khr           = (1U << 13),
        v_std_constrained_intra_pred_flag_set_bit_khr              = (1U << 14),
        v_std_entropy_coding_sync_enabled_flag_set_bit_khr         = (1U << 15),
        v_std_deblocking_filter_override_enabled_flag_set_bit_khr  = (1U << 16),
        v_std_dependent_slice_segments_enabled_flag_set_bit_khr    = (1U << 17),
        v_std_dependent_slice_segment_flag_set_bit_khr             = (1U << 18),
        v_std_slice_qp_delta_bit_khr                               = (1U << 19),
        v_std_different_slice_qp_delta_bit_khr                     = (1U << 20)
    };

    enum class video_encode_h265rate_control_flag_bits_khr : ktl::u32
    {
        v_rate_control_attempt_hrd_compliance_bit_khr            = (1U << 0),
        v_rate_control_regular_gop_bit_khr                       = (1U << 1),
        v_rate_control_reference_pattern_flat_bit_khr            = (1U << 2),
        v_rate_control_reference_pattern_dyadic_bit_khr          = (1U << 3),
        v_rate_control_temporal_sub_layer_pattern_dyadic_bit_khr = (1U << 4)
    };

    enum class video_encode_h265ctb_size_flag_bits_khr : ktl::u32
    {
        v_ctb_size_16_bit_khr = (1U << 0),
        v_ctb_size_32_bit_khr = (1U << 1),
        v_ctb_size_64_bit_khr = (1U << 2)
    };

    enum class video_encode_h265transform_block_size_flag_bits_khr : ktl::u32
    {
        v_transform_block_size_4_bit_khr  = (1U << 0),
        v_transform_block_size_8_bit_khr  = (1U << 1),
        v_transform_block_size_16_bit_khr = (1U << 2),
        v_transform_block_size_32_bit_khr = (1U << 3)
    };

    enum class video_encode_av1capability_flag_bits_khr : ktl::u32
    {
        v_capability_per_rate_control_group_min_max_q_index_bit_khr = (1U << 0),
        v_capability_generate_obu_extension_header_bit_khr          = (1U << 1),
        v_capability_primary_reference_cdf_only_bit_khr             = (1U << 2),
        v_capability_frame_size_override_bit_khr                    = (1U << 3),
        v_capability_motion_vector_scaling_bit_khr                  = (1U << 4)
    };

    enum class video_encode_av1std_flag_bits_khr : ktl::u32
    {
        v_std_uniform_tile_spacing_flag_set_bit_khr = (1U << 0),
        v_std_skip_mode_present_unset_bit_khr       = (1U << 1),
        v_std_primary_ref_frame_bit_khr             = (1U << 2),
        v_std_delta_q_bit_khr                       = (1U << 3)
    };

    enum class video_encode_av1rate_control_flag_bits_khr : ktl::u32
    {
        v_rate_control_regular_gop_bit_khr                   = (1U << 0),
        v_rate_control_temporal_layer_pattern_dyadic_bit_khr = (1U << 1),
        v_rate_control_reference_pattern_flat_bit_khr        = (1U << 2),
        v_rate_control_reference_pattern_dyadic_bit_khr      = (1U << 3)
    };

    enum class video_encode_av1superblock_size_flag_bits_khr : ktl::u32
    {
        v_superblock_size_64_bit_khr  = (1U << 0),
        v_superblock_size_128_bit_khr = (1U << 1)
    };

    enum class video_encode_av1prediction_mode_khr : ktl::u32
    {
        v_prediction_mode_intra_only_khr              = 0,
        v_prediction_mode_single_reference_khr        = 1,
        v_prediction_mode_unidirectional_compound_khr = 2,
        v_prediction_mode_bidirectional_compound_khr  = 3
    };

    enum class video_encode_av1rate_control_group_khr : ktl::u32
    {
        v_rate_control_group_intra_khr        = 0,
        v_rate_control_group_predictive_khr   = 1,
        v_rate_control_group_bipredictive_khr = 2
    };
    ...
    enum class video_encode_rgb_model_conversion_flag_bits_valve : ktl::u32
    {
    ...
    enum class video_encode_rgb_range_compression_flag_bits_valve : ktl::u32
    {
        v_ull_range_bit_valve    = (1U << 0),
        v_narrow_range_bit_valve = (1U << 1)
    };

    enum class video_encode_rgb_chroma_offset_flag_bits_valve : ktl::u32
    {

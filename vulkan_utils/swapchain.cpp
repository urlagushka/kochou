...
vk::utils::swapchain::swapchain(device & dev, const vk::raii::SurfaceKHR & surface)
    : __swapchain(VK_NULL_HANDLE), __images({}), __images_view(), __surface_format(), __extent2d(),
      ...
      __depth_view(VK_NULL_HANDLE)                                   // asd
{
    ...
    for (const auto & image : __images)
    {
        vk::ImageViewCreateInfo view_create_info(
            {}, image, vk::ImageViewType::e2D, __surface_format.format, vk::ComponentMapping(),
    ...
    vk::ImageViewCreateInfo view_info{
        {},           *__depth_image,         vk::ImageViewType::e2D,
        depth_format, vk::ComponentMapping{}, vk::ImageSubresourceRange{vk::ImageAspectFlagBits::eDepth, 0, 1, 0, 1}};

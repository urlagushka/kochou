...
vk::utils::shader vk::utils::load_from_file(const fs::path & path) {
...
std::vector<vk::utils::shader> vk::utils::load_from_dir(const fs::path & path) {
...
vk::raii::ShaderModule vk::utils::create_shader_module(device & dev, const fs::path & path,
                                                       vk::ShaderModuleCreateFlags flags) {
    auto shader_vec = load_from_file(path);
    vk::ShaderModuleCreateInfo shader_info = {flags, shader_vec.size(),

...
std::ostream & vk::operator<<(std::ostream & out, const vk::MemoryHeapFlags & rhs)
{
  out << ((rhs & MemoryHeapFlagBits::eDeviceLocal) ? "DEVICE_LOCAL_BIT\n" : "");
  out << ((rhs & MemoryHeapFlagBits::eMultiInstance) ? "MULTI_INSTANCE_BIT\n" : "");

  return out;
}

std::ostream & vk::operator<<(std::ostream & out, const vk::MemoryPropertyFlags & rhs)
{
  out << ((rhs & MemoryPropertyFlagBits::eDeviceLocal) ? "DEVICE_LOCAL_BIT\n" : "");
  out << ((rhs & MemoryPropertyFlagBits::eHostVisible) ? "HOST_VISIBLE_BIT\n" : "");
  out << ((rhs & MemoryPropertyFlagBits::eHostCoherent) ? "HOST_COHERENT_BIT\n" : "");
  out << ((rhs & MemoryPropertyFlagBits::eHostCached) ? "HOST_CACHED_BIT\n" : "");
  out << ((rhs & MemoryPropertyFlagBits::eLazilyAllocated) ? "LAZILIY_ALLOCATED_BIT\n" : "");

  return out;
}

std::ostream & vk::operator<<(std::ostream & out, const vk::MemoryHeap & rhs)
{
  out << "size: " << rhs.size << "\n";
  out << rhs.flags;
...
std::ostream & vk::operator<<(std::ostream & out, const vk::MemoryType & rhs)
{
...
std::ostream & vk::operator<<(std::ostream & out, const vk::PhysicalDeviceMemoryProperties & rhs)
{
...
std::ostream & vk::operator<<(std::ostream & out, const vk::PhysicalDeviceType & rhs)
{
  static std::map< vk::PhysicalDeviceType, std::string_view > dev_type = {
    {PhysicalDeviceType::eIntegratedGpu, "INTEGRATED GPU"},
    {PhysicalDeviceType::eDiscreteGpu, "DISCRETE GPU"},
    {PhysicalDeviceType::eVirtualGpu, "VIRTUAL GPU"},
    {PhysicalDeviceType::eCpu, "CPU"},
    {PhysicalDeviceType::eOther, "OTHER"}
  };
...
std::ostream & vk::operator<<(std::ostream & out, const vk::PhysicalDevice & rhs)
{
...
std::ostream & vk::operator<<(std::ostream & out, const Extent2D & rhs)
{
  out << "width: " << rhs.width << "\n";
...
std::ostream & vk::operator<<(std::ostream & out, const vk::Extent3D & rhs)
{
  out << "width: " << rhs.width << "\n";
  out << "height: " << rhs.height << "\n";
  out << "depth: " << rhs.depth;
...
std::ostream & vk::operator<<(std::ostream & out, const vk::QueueFlags & rhs)
{
  out << ((rhs & QueueFlagBits::eGraphics) ? "GRAPHICS_BIT\n" : "");
  out << ((rhs & QueueFlagBits::eCompute) ? "COMPUTE_BIT\n" : "");
  out << ((rhs & QueueFlagBits::eTransfer) ? "TRANSFER_BIT\n" : "");
  out << ((rhs & QueueFlagBits::eSparseBinding) ? "SPARSE_BINDING_BIT\n" : "");

  return out;
}

std::ostream & vk::operator<<(std::ostream & out, const vk::QueueFamilyProperties & rhs)
{
...
std::ostream & vk::operator<<(std::ostream & out, const Format & rhs)
{
  static std::map<vk::Format, std::string_view> format_type = {
...
std::ostream & vk::operator<<(std::ostream & out, const ColorSpaceKHR & rhs)
{
  static std::map< vk::ColorSpaceKHR, std::string_view > color_space_type = {
    {ColorSpaceKHR::eAdobergbLinearEXT, "eAdobergbLinearEXT"},
    {ColorSpaceKHR::eAdobergbNonlinearEXT, "eAdobergbNonlinearEXT"},
    {ColorSpaceKHR::eBt2020LinearEXT, "eBt2020LinearEXT"},
    {ColorSpaceKHR::eBt709LinearEXT, "eBt709LinearEXT"},
    {ColorSpaceKHR::eBt709NonlinearEXT, "eBt709NonlinearEXT"},
    {ColorSpaceKHR::eDciP3LinearEXT, "eDciP3LinearEXT"},
    {ColorSpaceKHR::eDciP3NonlinearEXT, "eDciP3NonlinearEXT"},
    {ColorSpaceKHR::eDisplayNativeAMD, "eDisplayNativeAMD"},
    {ColorSpaceKHR::eDisplayP3LinearEXT, "eDisplayP3LinearEXT"},
    {ColorSpaceKHR::eDisplayP3NonlinearEXT, "eDisplayP3NonlinearEXT"},
    {ColorSpaceKHR::eDolbyvisionEXT, "eDolbyvisionEXT"},
    {ColorSpaceKHR::eExtendedSrgbLinearEXT, "eExtendedSrgbLinearEXT"},
    {ColorSpaceKHR::eExtendedSrgbNonlinearEXT, "eExtendedSrgbNonlinearEXT"},
    {ColorSpaceKHR::eHdr10HlgEXT, "eHdr10HlgEXT"},
    {ColorSpaceKHR::eHdr10St2084EXT, "eHdr10St2084EXT"},
    {ColorSpaceKHR::ePassThroughEXT, "ePassThroughEXT"},
    {ColorSpaceKHR::eSrgbNonlinear, "eSrgbNonlinear"},
    {ColorSpaceKHR::eVkColorspaceSrgbNonlinear, "eVkColorspaceSrgbNonlinear"}
  };
...
std::ostream & vk::operator<<(std::ostream & out, const SurfaceFormatKHR & rhs)
{
  return out << rhs.colorSpace << "    " << rhs.format;
}

std::ostream & vk::operator<<(std::ostream & out, const SurfaceTransformFlagsKHR & rhs)
{
  out << ((rhs & SurfaceTransformFlagBitsKHR::eHorizontalMirror) ? "TRANSFORM_HORIZONTAL_MIRROR_BIT\n" : "");
  out << ((rhs & SurfaceTransformFlagBitsKHR::eHorizontalMirrorRotate180) ? "TRANSFORM_HORIZONTAL_MIRROR_ROTATE_180_BIT\n" : "");
  out << ((rhs & SurfaceTransformFlagBitsKHR::eHorizontalMirrorRotate270) ? "TRANSFORM_HORIZONTAL_MIRROR_ROTATE_270_BIT\n" : "");
  out << ((rhs & SurfaceTransformFlagBitsKHR::eHorizontalMirrorRotate90) ? "TRANSFORM_HORIZONTAL_MIRROR_ROTATE_90_BIT\n" : "");
  out << ((rhs & SurfaceTransformFlagBitsKHR::eIdentity) ? "TRANSFORM_HORIZONTAL_IDENTITY_BIT\n" : "");
  out << ((rhs & SurfaceTransformFlagBitsKHR::eInherit) ? "TRANSFORM_HORIZONTAL_INHERIT_BIT\n" : "");
  out << ((rhs & SurfaceTransformFlagBitsKHR::eRotate180) ? "TRANSFORM_ROTATE_180_BIT\n" : "");
  out << ((rhs & SurfaceTransformFlagBitsKHR::eRotate270) ? "TRANSFORM_ROTATE_270_BIT\n" : "");
  out << ((rhs & SurfaceTransformFlagBitsKHR::eRotate90) ? "TRANSFORM_ROTATE_90_BIT\n" : "");

  return out;
}
std::ostream & vk::operator<<(std::ostream & out, const SurfaceTransformFlagBitsKHR & rhs)
{
  static std::map< vk::SurfaceTransformFlagBitsKHR, std::string_view > surface_transform_type = {
    {SurfaceTransformFlagBitsKHR::eHorizontalMirror, "TRANSFORM_HORIZONTAL_MIRROR_BIT"},
    {SurfaceTransformFlagBitsKHR::eHorizontalMirrorRotate180, "TRANSFORM_HORIZONTAL_MIRROR_ROTATE_180_BIT"},
    {SurfaceTransformFlagBitsKHR::eHorizontalMirrorRotate270, "TRANSFORM_HORIZONTAL_MIRROR_ROTATE_270_BIT"},
    {SurfaceTransformFlagBitsKHR::eHorizontalMirrorRotate90, "TRANSFORM_HORIZONTAL_MIRROR_ROTATE_90_BIT"},
    {SurfaceTransformFlagBitsKHR::eIdentity, "TRANSFORM_HORIZONTAL_IDENTITY_BIT"},
    {SurfaceTransformFlagBitsKHR::eInherit, "TRANSFORM_HORIZONTAL_INHERIT_BIT"},
    {SurfaceTransformFlagBitsKHR::eRotate180, "TRANSFORM_ROTATE_180_BIT"},
    {SurfaceTransformFlagBitsKHR::eRotate270, "TRANSFORM_ROTATE_270_BIT"},
    {SurfaceTransformFlagBitsKHR::eRotate90, "TRANSFORM_ROTATE_90_BIT"},
  };
...
std::ostream & vk::operator<<(std::ostream & out, const CompositeAlphaFlagsKHR & rhs)
{
  out << ((rhs & CompositeAlphaFlagBitsKHR::eInherit) ? "COMPOSITE_ALPHA_INHERIT_BIT_KHR\n" : "");
  out << ((rhs & CompositeAlphaFlagBitsKHR::eOpaque) ? "COMPOSITE_ALPHA_OPAQUE_BIT_KHR\n" : "");
  out << ((rhs & CompositeAlphaFlagBitsKHR::ePostMultiplied) ? "COMPOSITE_ALPHA_POST_MULTIPLIED_BIT_KHR\n" : "");
  out << ((rhs & CompositeAlphaFlagBitsKHR::ePreMultiplied) ? "COMPOSITE_ALPHA_PRE_MULTIPLIED_KHR\n" : "");

  return out;
}

std::ostream & vk::operator<<(std::ostream & out, const ImageUsageFlags & rhs)
{
  out << ((rhs & ImageUsageFlagBits::eAttachmentFeedbackLoopEXT) ? "IMAGE_USAGE_ATTACHMENT_FEEDBACK_LOOP_BIT_EXT\n" : "");
  out << ((rhs & ImageUsageFlagBits::eColorAttachment) ? "IMAGE_USAGE_COLOR_ATTACHMENT_BIT\n" : "");
  out << ((rhs & ImageUsageFlagBits::eDepthStencilAttachment) ? "IMAGE_USAGE_DEPTH_STENCIL_ATTACHMENT_BIT\n" : "");
  out << ((rhs & ImageUsageFlagBits::eFragmentDensityMapEXT) ? "IMAGE_USAGE_FLAG_BITS_MAX_ENUM\n" : "");
  out << ((rhs & ImageUsageFlagBits::eFragmentShadingRateAttachmentKHR) ? "IMAGE_USAGE_FRAGMENT_DENSITY_MAP_BIT_EXT\n" : "");
  out << ((rhs & ImageUsageFlagBits::eFragmentShadingRateAttachmentKHR) ? "IMAGE_USAGE_FRAGMENT_SHADING_RATE_ATTACHMENT_BIT_KHR\n" : "");
  out << ((rhs & ImageUsageFlagBits::eHostTransfer) ? "IMAGE_USAGE_HOST_TRANSFER_BIT\n" : "");
  out << ((rhs & ImageUsageFlagBits::eHostTransferEXT) ? "IMAGE_USAGE_HOST_TRANSFER_BIT_EXT\n" : "");
  out << ((rhs & ImageUsageFlagBits::eInputAttachment) ? "IMAGE_USAGE_INPUT_ATTACHMENT_BIT\n" : "");
  out << ((rhs & ImageUsageFlagBits::eInvocationMaskHUAWEI) ? "IMAGE_USAGE_INVOCATION_MASK_BIT_HUAWEI\n" : "");
  out << ((rhs & ImageUsageFlagBits::eSampleBlockMatchQCOM) ? "IMAGE_USAGE_SAMPLE_BLOCK_MATCH_BIT_QCOM\n" : "");
  out << ((rhs & ImageUsageFlagBits::eSampleWeightQCOM) ? "IMAGE_USAGE_SAMPLE_WEIGHT_BIT_QCOM\n" : "");
  out << ((rhs & ImageUsageFlagBits::eSampled) ? "IMAGE_USAGE_SAMPLED_BIT\n" : "");
  out << ((rhs & ImageUsageFlagBits::eShadingRateImageNV) ? "IMAGE_USAGE_SHADING_RATE_IMAGE_BIT_NV\n" : "");
  out << ((rhs & ImageUsageFlagBits::eStorage) ? "IMAGE_USAGE_STORAGE_BIT\n" : "");
  out << ((rhs & ImageUsageFlagBits::eTransferDst) ? "IMAGE_USAGE_TRANSFER_DST_BIT\n" : "");
  out << ((rhs & ImageUsageFlagBits::eTransferSrc) ? "IMAGE_USAGE_TRANSFER_SRC_BIT\n" : "");
  out << ((rhs & ImageUsageFlagBits::eTransientAttachment) ? "IMAGE_USAGE_TRANSIENT_ATTACHMENT_BIT\n" : "");
  out << ((rhs & ImageUsageFlagBits::eVideoDecodeDpbKHR) ? "IMAGE_USAGE_VIDEO_DECODE_DPB_BIT_KHR\n" : "");
  out << ((rhs & ImageUsageFlagBits::eVideoDecodeDstKHR) ? "IMAGE_USAGE_VIDEO_DECODE_DST_BIT_KHR\n" : "");
  out << ((rhs & ImageUsageFlagBits::eVideoDecodeSrcKHR) ? "IMAGE_USAGE_VIDEO_DECODE_SRC_BIT_KHR\n" : "");
  out << ((rhs & ImageUsageFlagBits::eVideoEncodeDpbKHR) ? "IMAGE_USAGE_VIDEO_ENCODE_DPB_BIT_KHR\n" : "");
  out << ((rhs & ImageUsageFlagBits::eVideoEncodeDstKHR) ? "IMAGE_USAGE_VIDEO_ENCODE_DST_BIT_KHR\n" : "");
  out << ((rhs & ImageUsageFlagBits::eVideoEncodeEmphasisMapKHR) ? "IMAGE_USAGE_VIDEO_ENCODE_EMPHASIS_MAP_BIT_KHR\n" : "");
  out << ((rhs & ImageUsageFlagBits::eVideoEncodeQuantizationDeltaMapKHR) ? "IMAGE_USAGE_VIDEO_ENCODE_QUANTIZATION_DELTA_MAP_BIT_KHR\n" : "");
  out << ((rhs & ImageUsageFlagBits::eVideoEncodeSrcKHR) ? "IMAGE_USAGE_VIDEO_ENCODE_SRC_BIT_KHR\n" : "");

  return out;
}

std::ostream & vk::operator<<(std::ostream & out, const SurfaceCapabilitiesKHR & rhs)
{
